...
class RiceCultivation extends StatefulWidget {
  @override
  _RiceCultivationState createState() => _RiceCultivationState();
}

class _RiceCultivationState extends State<RiceCultivation> {
  @override
